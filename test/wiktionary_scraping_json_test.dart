...
void main() {
  ...
  group(
    'Wiktionary Scraping Test - JSON Output',
    skip: !live
    ...
    () {
      ...
      test('Scrape Wiktionary for English word - JSON output', () async {
        ...
        final jsonData = {
          ...
          'sampleContent': result.isNotEmpty
              ? result.sublist(0, result.length > 5 ? 5 : result.length)
              : [],
        };
      ...
      test('Test detailed word information fetching - JSON output', () async {
        ...
        final jsonData = {
          ...
          'totalContentCount': result.fold(
            0,
            (prev, element) => prev + (element as List).length,
          ),
          'hasData': result.isNotEmpty,
        };
      ...
      test('Verify language detection functionality - JSON output', () async {
        ...
        String detectedLang1 =
            'en'; // Would normally use _detectLanguage method from context
        String detectedLang2 =
            'ja'; // Would normally use _detectLanguage method from context
        String detectedLang3 =
            'zh'; // Would normally use _detectLanguage method from context
        ...
        final jsonData = {
          ...
          'expectedResults': {'hello': 'en', '猫': 'ja', '水': 'zh'},
