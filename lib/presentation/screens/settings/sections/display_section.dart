          ...
          children: [
            ...
            Padding(
              ...
              child: DropdownButtonFormField<int>(
                ...
                items: [
                  DropdownMenuItem(value: 0, child: Text(AppLocalizations.of(context)!.search)),
                  DropdownMenuItem(value: 1, child: Text(AppLocalizations.of(context)!.reader)),
                  DropdownMenuItem(value: 2, child: Text(AppLocalizations.of(context)!.wordLists)),
                  DropdownMenuItem(value: 3, child: Text(AppLocalizations.of(context)!.dictionaries)),
                  DropdownMenuItem(value: 4, child: Text(AppLocalizations.of(context)!.translator)),
                  DropdownMenuItem(value: 5, child: Text(AppLocalizations.of(context)!.settings)),
                ],
                onChanged: (value) {
                  if (value != null) {
