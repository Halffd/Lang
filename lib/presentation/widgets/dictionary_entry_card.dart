...
class DictionaryEntryCard extends StatelessWidget {
  ...
  /// Helper method to render definition content that might be
  /// plain text or structured JSON; shared implementation in
  ...
  Widget _renderDefinitionContent(
    ...
    return StructuredDefinition(definition: definition);
  }
                        ...
                        children: [
                          ...
                          if (_displayOptionsOf(context).showTags &&
                            ...
                            Wrap(
                              spacing: 4,
                              runSpacing: 4,
                              children: TagRenderer.renderTags(
                ...
                child: ClipRRect(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (entry.imageCaption != null &&
                          entry.imageCaption!.isNotEmpty)
                        Padding(
